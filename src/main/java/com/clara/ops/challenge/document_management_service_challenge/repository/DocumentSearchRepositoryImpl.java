...
public class DocumentSearchRepositoryImpl implements DocumentSearchRepository{
    ...
    public long countDocuments(DocumentSearchCriteria criteria) {
        StringBuilder sql = new StringBuilder("SELECT COUNT(*) FROM document_schema.documents d WHERE 1=1");
        Map<String, Object> parameters = new HashMap<>();
    ...
    private void appendFilterConditions(StringBuilder sql, Map<String, Object> parameters, DocumentSearchCriteria criteria) {
