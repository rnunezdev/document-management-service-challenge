...
public class DocumentServiceImplTest {
    ...
    void testUploadDocumentSuccess() throws Exception {
        ...
        DocumentUploadRequestDTO dto = new DocumentUploadRequestDTO("maria", "resume.pdf", List.of("job", "cv"), multipartFile);
    ...
    void testUploadDocumentNullUserShouldThrow() {
        DocumentUploadRequestDTO dto = new DocumentUploadRequestDTO(null, "file.pdf", List.of("tag"), multipartFile);
    ...
    void testUploadDocumentMinIOFailureShouldThrow() throws Exception {
        DocumentUploadRequestDTO dto = new DocumentUploadRequestDTO("maria", "fail.pdf", List.of("fail"), multipartFile);
