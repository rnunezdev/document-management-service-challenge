...
public class DocumentSearchRepositoryTest {
    ...
    @InjectMocks
    private DocumentSearchRepositoryImpl repository;
    ...
    void shouldReturnResultsWhenMatchingCriteria() {
        DocumentSearchCriteria criteria = new DocumentSearchCriteria("john", "report", List.of("finance", "q2"), 2, 5);
    ...
    void shouldThrowExceptionOnEntityManagerFailure() {
        ...
        when(entityManager.createNativeQuery(anyString(), eq(Document.class))).thenThrow(RuntimeException.class);
